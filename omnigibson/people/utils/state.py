...
from .rotations import rot_ENU_to_NED, rot_FLU_to_FRD
...
class State:
    ...
    def get_attitude_ned_frd(self):
        ...
        """
        attitude_frd_ned = rot_ENU_to_NED * \
            Rotation.from_quat(self.attitude) * rot_FLU_to_FRD
    ...
    def get_linear_body_velocity_ned_frd(self):
        ...
        linear_acc_body_flu = Rotation.from_quat(
            self.attitude).inv().apply(self.linear_acceleration)
